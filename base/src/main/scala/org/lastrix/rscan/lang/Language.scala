...
import org.lastrix.rscan.api.model.WithProperties

import _root_.java.util.ServiceLoader
import scala.jdk.javaapi.CollectionConverters

trait Language extends Comparable[Language] with WithProperties[Language] {
  def name: String
...
object Language {
  val DefaultPrintElement: String = "DefaultPrintElement"
